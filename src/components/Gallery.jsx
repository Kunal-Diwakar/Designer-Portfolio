...
const Gallery = () => {
  ...
  return (
    <div className="container" ref={container}>
      <div className="gallery-container relative w-screen h-full flex justify-center items-center transform-3d perspective-[2000px] will-change-transform overflow-hidden">
        <div className="gallery relative w-[600px] h-[600px] flex justify-center items-center origin-center will-change-transform"></div>
      </div>
